...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ' -1002289350150'))
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://cinema_house_13')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@cinema_house_dis) # Support Chat Link Without https:// or @

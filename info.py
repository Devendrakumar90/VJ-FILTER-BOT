...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002612046146'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002665868007')).split()]  # For Multiple Id Use One Space Between Each.
